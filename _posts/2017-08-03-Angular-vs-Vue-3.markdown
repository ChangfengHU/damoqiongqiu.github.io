...
但是，有一件事情非常奇怪，Vue里面到底有多少东西是抄袭的Angular呢？本文将会做出详细的列举和解释。
...
所以你可以发现，想要实现一套稳定健壮“双向绑定系统”并不是一件轻松的事情。那么，对于以上典型的3个问题，早期的AngularJS 1.x是如何解决的呢？
